IF EXISTS (SELECT * FROM sys.objects 
                WHERE object_id = OBJECT_ID(N'[dbo].[SP_UPD_CONSIGNATARIO_INACTIVAR]') 
                  AND type in (N'P', N'PC'))
BEGIN
	DROP PROCEDURE SP_UPD_CONSIGNATARIO_INACTIVAR
END

GO
CREATE PROCEDURE SP_UPD_CONSIGNATARIO_INACTIVAR  
	@ID_CONSIGNATARIO SMALLINT,	
	@ID_IDIOMA_LOGIN TINYINT
	
AS  
/*  
SP_UPD_CONSIGNATARIO_INACTIVAR  
ACTUALIZA EL CAMPO ACRTIVO DE UN REGISTRO EN CRUBRO
*/  
BEGIN  
	SET NOCOUNT OFF  
	...
	UPDATE CCONSIGNATARIO SET ACTIVO = 0 WHERE ID_CONSIGNATARIO = @ID_CONSIGNATARIO
