IF EXISTS (SELECT * FROM sys.objects 
                WHERE object_id = OBJECT_ID(N'[dbo].[SP_UPD_ARTICULO_ARCHIVO_IMG]') 
                  AND type in (N'P', N'PC'))
BEGIN
	DROP PROCEDURE SP_UPD_ARTICULO_ARCHIVO_IMG
END

GO
CREATE PROCEDURE SP_UPD_ARTICULO_ARCHIVO_IMG  
	@ID_ARTICULO SMALLINT,	
	@NOMBRE_ARCHIVO_IMG NVARCHAR(100),
	@ID_IDIOMA_LOGIN TINYINT
	
AS  
/*  
SP_UPD_ARTICULO_ARCHIVO_IMG  
ACTUALIZA UN REGISTRO EN CARTICULO
*/  
BEGIN  
	SET NOCOUNT OFF  
	...
	UPDATE CARTICULO SET NOMBRE_ARCHIVO_IMG = @NOMBRE_ARCHIVO_IMG WHERE ID_ARTICULO = @ID_ARTICULO
