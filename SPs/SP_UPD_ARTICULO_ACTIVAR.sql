IF EXISTS (SELECT * FROM sys.objects 
                WHERE object_id = OBJECT_ID(N'[dbo].[SP_UPD_ARTICULO_ACTIVAR]') 
                  AND type in (N'P', N'PC'))
BEGIN
	DROP PROCEDURE SP_UPD_ARTICULO_ACTIVAR
END

GO
CREATE PROCEDURE SP_UPD_ARTICULO_ACTIVAR  
	@ID_ARTICULO SMALLINT,	
	@ID_IDIOMA_LOGIN TINYINT
	
AS  
/*  
SP_UPD_ARTICULO_ACTIVAR  
...
BEGIN  
	...
	UPDATE CARTICULO SET ACTIVO = 1 WHERE ID_ARTICULO = @ID_ARTICULO
