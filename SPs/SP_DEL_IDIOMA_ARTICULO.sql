IF EXISTS (SELECT * FROM sys.objects 
                WHERE object_id = OBJECT_ID(N'dbo.SP_DEL_IDIOMA_ARTICULO') 
                  AND type in (N'P', N'PC'))
BEGIN
	DROP PROCEDURE SP_DEL_IDIOMA_ARTICULO
END

GO
CREATE PROCEDURE SP_DEL_IDIOMA_ARTICULO  
	@ID_ARTICULO SMALLINT,		
	@ID_IDIOMA_LOGIN SMALLINT
	
AS  
/*  
SP_DEL_IDIOMA_ARTICULO  
...
BEGIN  
	...
	DELETE RIDIOMA_ARTICULO WHERE ID_ARTICULO = @ID_ARTICULO
