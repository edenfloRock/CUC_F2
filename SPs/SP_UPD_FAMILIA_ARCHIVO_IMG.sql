IF EXISTS (SELECT * FROM sys.objects 
                WHERE object_id = OBJECT_ID(N'[dbo].[SP_UPD_FAMILIA_ARCHIVO_IMG]') 
                  AND type in (N'P', N'PC'))
BEGIN
	DROP PROCEDURE SP_UPD_FAMILIA_ARCHIVO_IMG
END

GO
CREATE PROCEDURE SP_UPD_FAMILIA_ARCHIVO_IMG  
	@ID_FAMILIA SMALLINT,	
...
AS  
/*  
SP_UPD_FAMILIA_ARCHIVO_IMG  
ACTUALIZA UN REGISTRO EN CFAMILIA
*/  
BEGIN  
	SET NOCOUNT OFF  
	...
	UPDATE CFAMILIA SET NOMBRE_ARCHIVO_IMG = @NOMBRE_ARCHIVO_IMG WHERE ID_FAMILIA = @ID_FAMILIA
