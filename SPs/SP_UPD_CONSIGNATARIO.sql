IF EXISTS (SELECT * FROM sys.objects 
                WHERE object_id = OBJECT_ID(N'[dbo].[SP_UPD_CONSIGNATARIO]') 
                  AND type in (N'P', N'PC'))
BEGIN
	DROP PROCEDURE SP_UPD_CONSIGNATARIO
END

GO
CREATE PROCEDURE SP_UPD_CONSIGNATARIO  
...
BEGIN  
	...
	UPDATE CCONSIGNATARIO SET NOMBRE_COMPLETO = @NOMBRE_COMPLETO WHERE ID_CONSIGNATARIO = @ID_CONSIGNATARIO
